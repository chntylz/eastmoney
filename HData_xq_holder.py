...
xq_cols = ' per_float_chg, stock_code, per_float, \
        top_float_holder_ratio, chg, price, bshare_holder, \
        ashare_holder, per_amount, top_holder_ratio, record_date,\
        holder_num, hshare_holder, price_ratio '
