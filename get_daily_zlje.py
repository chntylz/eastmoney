...
if __name__ == '__main__':
    ...
    df.to_csv('csv/' +   datetime.datetime.now().strftime('%Y-%m-%d-%H-%M') + '_zlje_1.csv', encoding='gbk')
    df_3.to_csv('csv/' + datetime.datetime.now().strftime('%Y-%m-%d-%H-%M') + '_zlje_3.csv', encoding='gbk')
    df_5.to_csv('csv/' + datetime.datetime.now().strftime('%Y-%m-%d-%H-%M') + '_zlje_5.csv', encoding='gbk')
    df_10.to_csv('csv/'+ datetime.datetime.now().strftime('%Y-%m-%d-%H-%M') + '_zlje_10.csv', encoding='gbk')
