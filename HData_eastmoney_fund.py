...
eastmoney_cols = ' security_inner_code,stock_name,record_date,org_type,' \
        + 'hould_num,total_shares,hold_value,freeshares_ratio,'\
        + 'holdcha,holdcha_num,holdcha_ratio,secucode,totalshares_ratio,org_type_name,'\
        + 'qchange_rate,free_market_cap,free_shares,security_type_code,'\
        + 'holdcha_value,stock_code,freeshares_ratio_change,type_num '
    ...
    def db_hdata_xq_create(self):
        ...
        self.cur.execute('''
            ...
            create table eastmoney_fund_table(
                ...
                free_shares  float,
                security_type_code  float,
                holdcha_value  float,
                stock_code  varchar,
                freeshares_ratio_change  float,
                type_num  float
                );
        ...
        my_dbg("db_eastmoney_fund_table_create finish")
        pass
