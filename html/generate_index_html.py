...
def showImageInHTML(imageTypes,savedir):
    ...
    with open(newfile,'w') as f:
        ...
        f.write('     <a href="fina-index.html"  target="_blank"> finance </a>\n')
        f.write('</td>\n')
        f.write('<td>\n')
        ...
        f.write('</td>\n')
        f.write('<td>\n')
        f.write('     <a href="./pepct-index.html"  target="_blank"> pe </a>\n')
        f.write('</td>\n')
        f.write('<td>\n')
        ...
        f.write('<a href="mailto:chntylz@gmail.com" style="color:red; font-size:27px">  @me </a>\n')
        f.write('    </tr>\n')
